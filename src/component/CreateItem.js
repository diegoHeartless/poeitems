    ...
    return (
        <div className="App">
            <div style={{display: 'flex'}}>
               ...
               <span className="item-box -unique" style={{position: 'fixed', left: '50px'}}><span className="header -double">
                ...
                <div style={{width: '55%'}}>
                    <div style={{width: '65%'}}>
                        ...
                        <Card title="Implict parameters" size="small">
                            <Checkbox onChange={() => setImpEnable((bool) => !bool)} style={{
                                'margin-top': '25px',
                                'margin-left': '10px'
                            }}>Implict enable</Checkbox>
                            {impEnable ? <Button onClick={() => addParam(setImpparam, impparam, 'impparam')}>Add Implict
                                param</Button>:''}
                            {ImpParams()}
                        </Card>
                        ...
                        <Button onClick={sendToBack}>Click to save</Button>
                    </div>
                </div>
            </div>
